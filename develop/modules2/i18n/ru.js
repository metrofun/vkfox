...
window.i18n["ru"]["Your message wasn't read"] = function(d){
var r = "";
...
window.i18n["ru"]["Show history"] = function(d){
var r = "";
r += "Показать историю";
return r;
}
window.i18n["ru"]["Open in New Tab"] = function(d){
var r = "";
...
window.i18n["ru"]["is_online_short"] = function(d){
var r = "";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
...
window.i18n["ru"]["went_offline_short"] = function(d){
var r = "";
if(!d){
throw new Error("MessageFormat: No data passed to function.");
}
...
window.i18n["ru"]["force online"] = function(d){
var r = "";
...
window.i18n["ru"]["show all"] = function(d){
var r = "";
r += "показать все";
return r;
}
window.i18n["ru"]["hide"] = function(d){
var r = "";
r += "скрыть";
return r;
}
